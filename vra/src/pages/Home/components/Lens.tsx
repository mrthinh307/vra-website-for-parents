...
// import { Lens } from "../../../components/lib-animated/lens";
import { Lens } from "../../../components/lib-animated/lens";
...
export function LensDemo() {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div className="w-full h-full relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-950 to-blue-900 p-8 border border-blue-700 shadow-lg">
        <Rays />
        <Beams />
        <div className="relative z-10 h-full w-full">          <Lens hovering={hovering} setHovering={setHovering}>
            <img
              src="https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3000&q=80"
              alt="Theo dõi tiến trình học"
              width={500}
              height={500}
          ...
          >
            ...
            <p className="text-blue-100 text-left mt-4">
              Hệ thống hỗ trợ phân tích và theo dõi chi tiết quá trình học tập của trẻ mỗi ngày, giúp phụ huynh nắm bắt tiến độ sát sao.
            </p>
          </motion.div>
        </div>
      </div>
...
const Beams = () => {
  return (
    ...
    >      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#1E40AF" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#3B82F6" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#2563EB" />
      </g>
      <defs>
        <filter
...
const Rays = ({ className }: { className?: string }) => {
  return (
    ...
    >
      ...
      >
        <path          d="M163.917 -89.0982C173.189 -72.1354 80.9618 2.11525 34.7334 30.1553C-11.495 58.1954 -106.505 97.514 -115.777 80.5512C-125.048 63.5885 -45.0708 -3.23233 1.15763 -31.2724C47.386 -59.3124 154.645 -106.061 163.917 -89.0982Z"
          fill="#3B82F6"
        />
      </g>
      <g
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#1E40AF" />
          <stop offset="0.781583" stopColor="#3B82F6" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.214779" stopColor="#2563EB" />
          <stop offset="0.781583" stopColor="#60A5FA" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.214779" stopColor="#1D4ED8" />
          <stop offset="0.781583" stopColor="#3B82F6" stopOpacity="0" />
